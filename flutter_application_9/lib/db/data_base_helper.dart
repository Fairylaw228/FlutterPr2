...
import 'package:flutter_application_5/data/model/Dostavka.dart';
import 'package:flutter_application_5/data/model/Doljnost.dart';
import 'package:flutter_application_5/data/model/Polzovatel.dart';
import 'package:flutter_application_5/data/model/Produksia.dart';
import 'package:flutter_application_5/data/model/Strana.dart';
import 'package:flutter_application_5/data/model/Zakaz.dart';
import 'package:flutter_application_5/data/model/Zapasi.dart';
import 'package:path/path.dart';
import 'package:sqflite/sqflite.dart';
import 'package:path_provider/path_provider.dart' as path_provider;

import '../../common/data_base_request.dart';
import '../data/model/Roli.dart';
import '../data/model/Sotrudniki.dart';
...
class DataBaseHelper {
  ...
  Future<void> init() async {
    ...
    _pathDB = join(_appDocumentDirectory.path, 'skladbase.db');
